...
export default function AOIViewer() {
   ...
   const [isFollowUpsResizing, setIsFollowUpsResizing] =
      useState(false);
   const [followUpsResizeStartX, setFollowUpsResizeStartX] =
      useState(0);
   const [followUpsResizeStartWidth, setFollowUpsResizeStartWidth] =
      useState(0);
