-- Schema do banco de dados OrBee.Online
-- Supabase PostgreSQL
...
CREATE TABLE IF NOT EXISTS monitored_areas (
    ...
    geometry GEOGRAPHY(POLYGON, 4326), -- Polígono da área (opcional)
...
-- Índices para performance
CREATE INDEX IF NOT EXISTS idx_observations_location ON observations USING GIST (location_point);
