      ...
      >
         ...
         <div className="container mx-auto px-6 py-2 relative z-10">
            ...
            >
               ...
               >
                  <div
                     className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#2f4538] to-[#1a2e1a] text-white font-semibold rounded-2xl hover:from-[#1a2e1a] hover:to-[#2f4538] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#2f4538]/25 cursor-pointer border border-[#2f4538]/30 backdrop-blur-sm"
                     style={{
                        fontFamily:
                           '"PP Fragment Glare Regular", "PP Fragment Glare", serif',
                     }}
