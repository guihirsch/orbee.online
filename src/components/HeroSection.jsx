    ...
    <section className="relative flex min-h-screen flex-col overflow-hidden">
      ...
      <div className="relative z-40 flex flex-1 items-center justify-center px-6 py-16">
        <div className="mx-auto max-w-5xl text-center">
          {/* Refined Badge */}
          <div className="animate-fade-in-up mb-6 inline-flex items-center rounded-full border border-emerald-400/20 bg-emerald-500/10 px-4 py-2 backdrop-blur-sm">
          ...
          <h1 className="animate-fade-in-up animation-delay-200 mb-6 text-4xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
            <span className="mb-2 block text-white">Ações locais</span>
          ...
          <p className="animate-fade-in-up animation-delay-400 mx-auto mb-10 max-w-3xl text-lg leading-relaxed text-slate-300 md:text-xl">
            ...
            que monitora matas ciliares e orienta ações de restauração e
            preservação.
          </p>
          ...
          <div className="animate-fade-in-up animation-delay-600 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <button
              ...
              className="group relative flex items-center gap-2 overflow-hidden rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-6 py-4 font-medium text-emerald-300 backdrop-blur-sm transition-all duration-300 hover:border-emerald-400/50 hover:bg-emerald-500/20"
            >
