...
const Footer = () => {
   ...
   return (
      <footer className="relative text-gray-900 overflow-hidden bg-white">
         <div
            className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 fade-in-on-scroll ${footerVisible ? "visible" : ""}`}
            ref={footerRef}
         >
            {/* Main Footer Content */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
               ...
               <div className="lg:col-span-2">
                  ...
                  <p className="text-gray-600 mb-6 max-w-md leading-relaxed">
                     ...
                     <br />
                     Conectamos satélites, comunidades e governos para ações
                     locais com impacto global.
                  </p>

                  {/* Newsletter Signup */}
                  <div className="mb-6">
                     <h4 className="text-lg font-semibold mb-3 text-emerald-600">
                     ...
                     <div className="flex flex-col sm:flex-row gap-3">
                        <input
                           ...
                           className="flex-1 px-4 py-3 bg-white/90 border border-emerald-400/30 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 backdrop-blur-sm"
                        />
                  ...
                  <div className="flex space-x-4">
                     {socialLinks.map((social, index) => (
                        <a
                           key={index}
                           href={social.href}
                           className="w-12 h-12 bg-white/90 border border-emerald-400/20 rounded-xl flex items-center justify-center text-gray-600 hover:text-white hover:bg-emerald-600 transition-all duration-300 hover:scale-110 hover:shadow-lg backdrop-blur-sm"
               ...
               {/* Navigation Links */}
               <div>
                  <h3 className="text-lg font-semibold mb-6 text-emerald-600">
                     Navegação
                  </h3>
                  <ul className="space-y-3">
                     {navigationLinks.map((link, index) => (
                        <li key={index}>
                           <Link
                              to={link.href}
                              className="text-gray-600 hover:text-gray-900 hover:translate-x-2 transition-all duration-300 flex items-center group"
                           >
                              <svg
