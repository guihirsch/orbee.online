...
const Dashboard = () => {
   ...
   if (loading) {
      return <div className="space-y-8">Carregando...</div>;
   }
            ...
            <div className="space-y-8">
               ...
               <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
                              ...
                              <div className="relative">
                                 ...
                                 {activeTooltip === "ndvi" && (
                                    <div className="absolute bottom-full left-1/2 z-10 mb-2 w-64 -translate-x-1/2 transform rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                       Índice de Vegetação: 0-0.3 (solo/água),
                                       0.3-0.6 (vegetação esparsa), 0.6+
                                       (vegetação densa)
                                    </div>
                                 )}
                              </div>
                           ...
                           <div className="flex items-center gap-2">
                              ...
                              <div className="relative">
                                 <Info
                                    className="h-4 w-4 cursor-help text-gray-400 hover:text-gray-600"
                                    onMouseEnter={() =>
                                       setActiveTooltip("coverage")
                                    }
                                    onMouseLeave={() => setActiveTooltip(null)}
                                 />
                                 {activeTooltip === "coverage" && (
                                    <div className="absolute bottom-full left-1/2 z-10 mb-2 w-64 -translate-x-1/2 transform rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                       Percentual da área com vegetação ativa
                                       detectada por satélite
                                    </div>
                                 )}
                              </div>
                           </div>
                  ...
                  <div className="card">
                           ...
                           <div className="flex items-center gap-2">
                              ...
                              <div className="relative">
                                 <Info
                                    className="h-4 w-4 cursor-help text-gray-400 hover:text-gray-600"
                                    onMouseEnter={() =>
                                       setActiveTooltip("quality")
                                    }
                                    onMouseLeave={() => setActiveTooltip(null)}
                                 />
                                 {activeTooltip === "quality" && (
                                    <div className="absolute bottom-full left-1/2 z-10 mb-2 w-64 -translate-x-1/2 transform rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                       Confiabilidade baseada em cobertura de
                                       nuvens e resolução dos dados satelitais
                                    </div>
                                 )}
                              </div>
                           </div>
                     ...
                     <p className="mt-1 text-xs text-gray-500">
                        {mockData.pixelsAnalyzed.toLocaleString()} pixels
                        analisados
                     </p>
                  </div>
                           ...
                           <div className="flex items-center gap-2">
                              ...
                              <div className="relative">
                                 <Info
                                    className="h-4 w-4 cursor-help text-gray-400 hover:text-gray-600"
                                    onMouseEnter={() =>
                                       setActiveTooltip("engagement")
                                    }
                                    onMouseLeave={() => setActiveTooltip(null)}
                                 />
                                 {activeTooltip === "engagement" && (
                                    <div className="absolute bottom-full left-1/2 z-10 mb-2 w-64 -translate-x-1/2 transform rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                       Relatórios e validações da comunidade
                                       local
                                    </div>
                                 )}
                              </div>
               ...
               <div className="card">
                  <div className="mb-6">
                     ...
                     <p className="text-sm text-gray-600">
                        Métricas avançadas para monitoramento técnico e
                           ...
                           <div className="relative">
                              ...
                              {activeTooltip === "biomass" && (
                                 <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                    Densidade de matéria vegetal. Valores altos
                                    indicam vegetação robusta e saudável.
                                 </div>
                              )}
                           </div>
                        </div>
                     ...
                     <div className="rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 p-4">
                        <div className="mb-3 flex items-center justify-between">
                           ...
                           <div className="relative">
                              <Info
                                 ...
                                 onMouseEnter={() =>
                                    setActiveTooltip("moisture")
                                 }
                                 onMouseLeave={() => setActiveTooltip(null)}
                              />
                              {activeTooltip === "moisture" && (
                                 <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                    Nível de água na vegetação. Importante para
                        ...
                        <div className="mt-2 h-2 rounded-full bg-blue-200">
                           <div
                              ...
                              style={{
                                 width: `${mockData.moistureIndex * 100}%`,
                              }}
                           ></div>
                        </div>
                     </div>
                        ...
                        <div className="mb-3 flex items-center justify-between">
                           ...
                           <div className="relative">
                              ...
                              {activeTooltip === "temperature" && (
                                 <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                    Temperatura da superfície terrestre. Afeta o
                                    crescimento e saúde da vegetação.
                                 </div>
                              )}
                           </div>
                        </div>
                        ...
                        <div className="mb-3 flex items-center justify-between">
                           ...
                           <div className="relative">
                              <Info
                                 ...
                                 onMouseEnter={() =>
                                    setActiveTooltip("seasonal")
                                 }
                                 onMouseLeave={() => setActiveTooltip(null)}
                              />
                              {activeTooltip === "seasonal" && (
                                 <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                    Padrão de crescimento esperado para a época
                                    do ano na região.
                                 </div>
                              )}
                           </div>
                           ...
                           <div className="mb-3 flex items-center justify-between">
                              ...
                              <div className="relative">
                                 <Info
                                    className="h-4 w-4 cursor-help text-gray-400 hover:text-gray-600"
                                    onMouseEnter={() =>
                                       setActiveTooltip("historical")
                                    }
                                    onMouseLeave={() => setActiveTooltip(null)}
                                 />
                                 {activeTooltip === "historical" && (
                                    <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                       Comparação do NDVI atual com a média dos
                                       últimos 12 meses
                                    </div>
                                 )}
                              </div>
                  ...
                  <div className="card">
                     ...
                     <div className="space-y-4">
                        ...
                        <div className="rounded-lg border border-green-200 bg-green-50 p-3">
                           ...
                           <p className="text-xs text-green-600">
                              Sua região está entre as 20% melhores em saúde
                              vegetal
                           </p>
                        </div>
                     </div>
               ...
               <div className="card">
                  <div className="mb-6">
                     ...
                     <p className="text-sm text-gray-600">
                        Indicadores técnicos sobre a precisão e confiabilidade
                        das análises satelitais
                     </p>
                  </div>
                        ...
                        <div className="mb-3 flex items-center justify-between">
                           ...
                           <div className="relative">
                              <Info
                                 className="h-4 w-4 cursor-help text-blue-600 hover:text-blue-800"
                                 onMouseEnter={() =>
                                    setActiveTooltip("resolution")
                                 }
                                 onMouseLeave={() => setActiveTooltip(null)}
                              />
                              {activeTooltip === "resolution" && (
                                 <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                    Resolução espacial dos dados Sentinel-2.
                                    Menor valor = maior precisão.
                                 </div>
                              )}
                           </div>
                        </div>
                        ...
                        <div className="mb-3 flex items-center justify-between">
                           ...
                           <div className="relative">
                              <Info
                                 className="h-4 w-4 cursor-help text-green-600 hover:text-green-800"
                                 onMouseEnter={() =>
                                    setActiveTooltip("frequency")
                                 }
                                 onMouseLeave={() => setActiveTooltip(null)}
                              />
                              {activeTooltip === "frequency" && (
                                 <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                    Frequência de passagem do satélite sobre a
                                    região monitorada.
                                 </div>
                              )}
                           </div>
                        ...
                        <div className="mb-3 flex items-center justify-between">
                           ...
                           <div className="relative">
                              ...
                              {activeTooltip === "clouds" && (
                                 <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                    Percentual de cobertura de nuvens na última
                                    imagem. Afeta a qualidade dos dados.
                                 </div>
                              )}
                           </div>
                        </div>
                                 ...
                                 <div className="relative">
                                    ...
                                    {activeTooltip === "ndvi-error" && (
                                       <div className="absolute bottom-full left-1/2 z-10 mb-2 w-48 -translate-x-1/2 transform rounded bg-black border border-gray-600 px-2 py-1 text-xs text-white shadow-lg">
                                          Margem de erro típica nas medições
                                          NDVI
                                       </div>
                                    )}
                                 </div>
                  ...
                  <div className="mt-6 rounded-lg border border-green-200 bg-gradient-to-r from-green-50 to-blue-50 p-4">
                        ...
                        <div className="flex items-center gap-2">
                           ...
                           <div className="relative">
                              <Info
                                 className="h-4 w-4 cursor-help text-gray-400 hover:text-gray-600"
                                 onMouseEnter={() =>
                                    setActiveTooltip("reliability")
                                 }
                                 onMouseLeave={() => setActiveTooltip(null)}
                              />
                              {activeTooltip === "reliability" && (
                                 <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                    Índice calculado com base na qualidade dos
                                    dados, cobertura de nuvens, calibração e
                                    validação
                                 </div>
                              )}
                           </div>
                     ...
                     <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600">
                           Baseado em {mockData.pixelsAnalyzed.toLocaleString()}{" "}
                           pixels analisados
                        </span>
                        <div className="flex items-center gap-1">
                           <div className="h-2 w-2 rounded-full bg-green-500"></div>
               ...
               <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  ...
                  <div className="card">
                     <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-600">
                           Estimativas de benefícios ambientais da vegetação
                           monitorada
                        </p>
                     </div>
                           ...
                           <div className="mb-3 flex items-center justify-between">
                              ...
                              <div className="relative">
                                 <Info
                                    className="h-4 w-4 cursor-help text-green-600 hover:text-green-800"
                                    onMouseEnter={() =>
                                       setActiveTooltip("carbon")
                                    }
                                    onMouseLeave={() => setActiveTooltip(null)}
                                 />
                                 {activeTooltip === "carbon" && (
                                    <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                       Estimativa baseada na biomassa vegetal e
                                       área de cobertura
                                    </div>
                                 )}
                              </div>
                           ...
                           <div className="mb-3 flex items-center justify-between">
                              ...
                              <div className="relative">
                                 <Info
                                    className="h-4 w-4 cursor-help text-blue-600 hover:text-blue-800"
                                    onMouseEnter={() =>
                                       setActiveTooltip("thermal")
                                    }
                                    onMouseLeave={() => setActiveTooltip(null)}
                                 />
                                 {activeTooltip === "thermal" && (
                                    <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                       Redução de temperatura proporcionada pela
                                       vegetação
                                    </div>
                                 )}
                              </div>
                           ...
                           <div className="mb-3 flex items-center justify-between">
                              ...
                              <div className="relative">
                                 <Info
                                    ...
                                    onMouseEnter={() =>
                                       setActiveTooltip("water")
                                    }
                                    onMouseLeave={() => setActiveTooltip(null)}
                                 />
                                 {activeTooltip === "water" && (
                                    <div className="absolute bottom-full right-0 z-10 mb-2 w-64 rounded-lg bg-black border border-gray-600 px-3 py-2 text-xs text-white shadow-lg">
                                       Capacidade de retenção hídrica da
                                       vegetação
                                    </div>
                                 )}
                              </div>
                  ...
                  <div className="card">
                     <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-600">
                           Padrões de crescimento e comportamento da vegetação
                           ao longo do ano
                        </p>
                     </div>
                     ...
                     <div className="space-y-4">
                        <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                           ...
                           <p className="mb-3 text-sm text-green-600">
                              Sua área apresenta excelente saúde vegetal.
                        ...
                        <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                           ...
                           <p className="mb-3 text-sm text-blue-600">
                              Contribua com observações locais para melhorar a
                              precisão dos dados.
                           </p>
                     ...
                     <div className="space-y-4">
                        <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
                           ...
                           <p className="mb-3 text-sm text-yellow-600">
                              Período de crescimento ativo. Aumente a frequência
                              de monitoramento.
                           </p>
                        ...
                        <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                           ...
                           <p className="mb-3 text-sm text-purple-600">
                              Baseado nos dados atuais, considere estas ações
                              preventivas.
                           </p>
               ...
               <div className="card">
                  ...
                  <div className="rounded-lg bg-gray-50 p-4">
                     <p className="mb-4 text-sm text-gray-600">
                        Ajude a melhorar a precisão dos dados compartilhando
                        suas observações locais.
                     </p>
